...
. In Cursor chat: `create lab module`
. Answer: `existing lab`
...
. In Cursor chat: `create demo module`
...
* *Quick Guide*: This file (README-CURSOR.adoc)
