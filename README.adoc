...
. Produces
+
image::.images/dev-mode.png[]

== Creating Content with Claude Code

The https://github.com/rhpds/rhdp-skills-marketplace[RHDP Skills Marketplace] provides Claude Code skills for generating and validating Showroom content.
...
[source,sh]
----
# Install RHDP Skills Marketplace
# See https://github.com/rhpds/rhdp-skills-marketplace for setup instructions

# Then run a skill in your Showroom repo
/showroom:create-lab
----
