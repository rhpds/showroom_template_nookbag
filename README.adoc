...
This repository includes Claude Code skills to help you create professional Red Hat workshop and demo content.
...
. Run a skill by name (without `/`): `lab-module`, `demo-module`, or `verify-content`

For detailed documentation on using Claude skills, see `CLAUDE-SKILLS-GUIDE.md`.
