...
Make the collection version and dev-mode overridable from the catalog:
+
[source,yaml,subs="+attributes"]
----
__meta__:
...
----
+
See xref:ocp4-role-reference.adoc#_dev_mode[Dev Mode] in the OCP4 Role Reference for the full list of dev-mode variables.
