...
=== Platform Engineer Activity: Configure Adoption Insights

Adoption Insights is enabled by default as of {product_name_rhdh} v1.8. This plugin requires additional configuration to display accurate user metrics. Specifically, the `licensedUsers` configuration is used to provide accurate insight into the usage of {product_name_rhdh} by actual versus licensed number of users.
...
=== Developer Activity: Generate Additional Data for Adoption Insights
