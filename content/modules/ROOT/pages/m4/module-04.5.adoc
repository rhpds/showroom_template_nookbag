...
. Access the *CI tab* to view the pipeline. You will see a new pipeline being triggered for the change you just made. Shortly, the pipeline will be marked as *Succeeded*
+
