...
The `mermaid` extension is available in this environment. This allows you to create diagrams and visualizations using text and code.

Include the extension in your `site.yml` or `default-site.yml` file:
...
Here is an example of Mermaid code:
