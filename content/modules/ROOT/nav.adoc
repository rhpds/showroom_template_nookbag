...
** xref:m3/module-03.4.adoc[3.3 Developer Activity: Create a new Component from the Template]
** xref:m3/module-03.5.adoc[3.4 Developer Activity: Update a Component's Catalog Info]
** xref:m3/module-03.6.adoc[3.5 Platform Engineer Activity: Enhance the Template & Component with Plugins]
** xref:m3/module-03.7.adoc[3.6 Platform Engineer Activity: Setup RBAC]
